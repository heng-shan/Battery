...
#unix:!macx: LIBS += -L$$PWD/../miniconda3/envs/battery/lib/ -lpython3.7m

#INCLUDEPATH += $$PWD/../miniconda3/envs/battery/include
#DEPENDPATH += $$PWD/../miniconda3/envs/battery/include
